import { solved, toSolve, wrong } from './puzzles.js'

// explicitly validates a completed sudoku puzzle
// an incomplete or unsolved puzzle is false
// return is an object whether or not puzzle is correct
// if false, returns object with information about first
function validateSudoku ( puzzle )
{
  ...
  return complete
  /** these properties are irrelevant (only added when false)
    // reason: `Row ${r} is invalid.`,
    // location: "row",
    // index: r,
    // missing  */
...
console.log( 'solved result:', validateSudoku( solved ) )
console.log('toSolve result:', validateSudoku(toSolve))
// console.log( 'wrong result:', validateSudoku( wrong ) )
